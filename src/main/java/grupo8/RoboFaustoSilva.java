 ...
 * @author ribadas
 */
public class RoboFaustoSilva extends AdvancedRobot {

    public static String FICHERO_REGLAS = "grupo8/reglas/reglas_fausto.drl";
    ...
    private void crearBaseConocimiento() {
        String ficheroReglas = System.getProperty("robot.reglas", RoboFaustoSilva.FICHERO_REGLAS);

        DEBUG.mensaje("crear base de conocimientos");
        kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        
        DEBUG.mensaje("cargar reglas desde "+ficheroReglas);
        kbuilder.add(ResourceFactory.newClassPathResource(ficheroReglas, RoboFaustoSilva.class), ResourceType.DRL);
    ...
    private Vector<Accion> recuperarAcciones() {
        ...
        for (QueryResultsRow resultado : ksession.getQueryResults(RoboFaustoSilva.CONSULTA_ACCIONES)) {
